  ...
  return (
    <div className="grid grid-cols-1 place-items-center py-4 md:grid-cols-[3fr_5fr] text-black  px-8 ">
      <div className="space-y-4">
        <img
          alt=""
          className=" md:w-2/3   w-full  border-4 border-gray-400"
          src={hero1}
        />{" "}
        <div className="flex  md:space-x-20 space-x-8  ml-2 place-content-center md:place-content-start md:py-0  ">
          <svg
      ...
      <div className="flex flex-col place-content-center space-y-8 md:space-y-4">
        {" "}
        <p className="m-6 md:mr-22 text-2xl md:text-3xl leading-normal md:leading-relaxed">
