    ...
    <nav className=" items-center justify-between bg-white p-4 grid-cols-4">
      <div className="flex items-center">
        <svg
          ...
          strokeWidth="1.5"
          stroke="black"
          className="h-12 inline-block mr-4 mt-2"
        >
          <path
            strokeLinecap="round"
        ...
        <p className="font-semibold text-black text-4xl tracking-tight flex-grow hidden md:block">
          Lakshman 'Lucky' Hariharan
        </p>
        <div className="font-semibold text-4xl md:hidden">Lucky Hariharan</div>
